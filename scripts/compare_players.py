...
# Player views
jokic_filters = [GroupFilter(column_name='playFNm', group='Nikola'),
				 GroupFilter(column_name='playLNm', group='Jokić')]
jokic_view = CDSView(source=players, filters=jokic_filters)

embiid_filters = [GroupFilter(column_name='playFNm', group='Joel'),
...
# Figures
hide_fig = figure(**rebound_figure_keywords,
